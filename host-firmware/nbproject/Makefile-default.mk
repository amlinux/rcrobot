...
IMAGE_TYPE=debug
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/host-firmware.${IMAGE_TYPE}.cof
else
...
# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1493717523/radio.p1 ${OBJECTDIR}/crc.p1 ${OBJECTDIR}/rchost.p1 ${OBJECTDIR}/usart.p1
...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/host-firmware.${IMAGE_TYPE}.cof
...
${OBJECTDIR}/_ext/1493717523/radio.p1: ../robot-firmware/radio.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --scandep --pass1 ../robot-firmware/radio.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir=${OBJECTDIR}/_ext/1493717523 -D_XTAL_FREQ=16000000 -DRADIO_EN_ANSEL=ANSELB -DRADIO_EN_TRIS=TRISB -DRADIO_EN_LAT=LATB -DRADIO_TXRX_ANSEL=ANSELB -DRADIO_TXRX_TRIS=TRISB -DRADIO_TXRX_LAT=LATB -DRADIO_SND_ANSEL=ANSELC -DRADIO_SND_TRIS=TRISC -DRADIO_SND_LAT=LATC -DRADIO_RCV_ANSEL=ANSELC -DRADIO_RCV_TRIS=TRISC -DRADIO_RCV_PORT=PORTC -DRADIO_EN_BIT=5 -DRADIO_TXRX_BIT=4 -DRADIO_SND_BIT=4 -DRADIO_RCV_BIT=5 -N31 --warn=9 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,+stackcall,+clib --opt=default,+asm,-asmfile,+speed,-space,-debug,-9 -D__DEBUG --debugger=pickit3  --double=24 --float=24 --addrqual=ignore --mode=lite -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	echo "${OBJECTDIR}/_ext/1493717523/radio.p1:\\" > ${OBJECTDIR}/_ext/1493717523/radio.p1.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	@cat ${OBJECTDIR}/_ext/1493717523/radio.dep | sed -e 's/^ *//' -e 's/\\/\//g' -e 's/ /\\ /g' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/_ext/1493717523/radio.p1.d
else 
	@cat ${OBJECTDIR}/_ext/1493717523/radio.dep | sed -e 's/^ *//' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/_ext/1493717523/radio.p1.d
endif
${OBJECTDIR}/crc.p1: crc.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --scandep --pass1 crc.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir=${OBJECTDIR} -D_XTAL_FREQ=16000000 -DRADIO_EN_ANSEL=ANSELB -DRADIO_EN_TRIS=TRISB -DRADIO_EN_LAT=LATB -DRADIO_TXRX_ANSEL=ANSELB -DRADIO_TXRX_TRIS=TRISB -DRADIO_TXRX_LAT=LATB -DRADIO_SND_ANSEL=ANSELC -DRADIO_SND_TRIS=TRISC -DRADIO_SND_LAT=LATC -DRADIO_RCV_ANSEL=ANSELC -DRADIO_RCV_TRIS=TRISC -DRADIO_RCV_PORT=PORTC -DRADIO_EN_BIT=5 -DRADIO_TXRX_BIT=4 -DRADIO_SND_BIT=4 -DRADIO_RCV_BIT=5 -N31 --warn=9 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,+stackcall,+clib --opt=default,+asm,-asmfile,+speed,-space,-debug,-9 -D__DEBUG --debugger=pickit3  --double=24 --float=24 --addrqual=ignore --mode=lite -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	echo "${OBJECTDIR}/crc.p1:\\" > ${OBJECTDIR}/crc.p1.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	@cat ${OBJECTDIR}/crc.dep | sed -e 's/^ *//' -e 's/\\/\//g' -e 's/ /\\ /g' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/crc.p1.d
else 
	@cat ${OBJECTDIR}/crc.dep | sed -e 's/^ *//' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/crc.p1.d
endif
${OBJECTDIR}/usart.p1: usart.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --scandep --pass1 usart.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir=${OBJECTDIR} -D_XTAL_FREQ=16000000 -DRADIO_EN_ANSEL=ANSELB -DRADIO_EN_TRIS=TRISB -DRADIO_EN_LAT=LATB -DRADIO_TXRX_ANSEL=ANSELB -DRADIO_TXRX_TRIS=TRISB -DRADIO_TXRX_LAT=LATB -DRADIO_SND_ANSEL=ANSELC -DRADIO_SND_TRIS=TRISC -DRADIO_SND_LAT=LATC -DRADIO_RCV_ANSEL=ANSELC -DRADIO_RCV_TRIS=TRISC -DRADIO_RCV_PORT=PORTC -DRADIO_EN_BIT=5 -DRADIO_TXRX_BIT=4 -DRADIO_SND_BIT=4 -DRADIO_RCV_BIT=5 -N31 --warn=9 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,+stackcall,+clib --opt=default,+asm,-asmfile,+speed,-space,-debug,-9 -D__DEBUG --debugger=pickit3  --double=24 --float=24 --addrqual=ignore --mode=lite -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	echo "${OBJECTDIR}/usart.p1:\\" > ${OBJECTDIR}/usart.p1.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	@cat ${OBJECTDIR}/usart.dep | sed -e 's/^ *//' -e 's/\\/\//g' -e 's/ /\\ /g' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/usart.p1.d
else 
	@cat ${OBJECTDIR}/usart.dep | sed -e 's/^ *//' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/usart.p1.d
endif
${OBJECTDIR}/rchost.p1: rchost.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --scandep --pass1 rchost.c $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir=${OBJECTDIR} -D_XTAL_FREQ=16000000 -DRADIO_EN_ANSEL=ANSELB -DRADIO_EN_TRIS=TRISB -DRADIO_EN_LAT=LATB -DRADIO_TXRX_ANSEL=ANSELB -DRADIO_TXRX_TRIS=TRISB -DRADIO_TXRX_LAT=LATB -DRADIO_SND_ANSEL=ANSELC -DRADIO_SND_TRIS=TRISC -DRADIO_SND_LAT=LATC -DRADIO_RCV_ANSEL=ANSELC -DRADIO_RCV_TRIS=TRISC -DRADIO_RCV_PORT=PORTC -DRADIO_EN_BIT=5 -DRADIO_TXRX_BIT=4 -DRADIO_SND_BIT=4 -DRADIO_RCV_BIT=5 -N31 --warn=9 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,+stackcall,+clib --opt=default,+asm,-asmfile,+speed,-space,-debug,-9 -D__DEBUG --debugger=pickit3  --double=24 --float=24 --addrqual=ignore --mode=lite -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	echo "${OBJECTDIR}/rchost.p1:\\" > ${OBJECTDIR}/rchost.p1.d
ifneq (,$(findstring MINGW32,$(OS_CURRENT))) 
	@cat ${OBJECTDIR}/rchost.dep | sed -e 's/^ *//' -e 's/\\/\//g' -e 's/ /\\ /g' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/rchost.p1.d
else 
	@cat ${OBJECTDIR}/rchost.dep | sed -e 's/^ *//' -e 's/^.*$$/ &\\/g'  >> ${OBJECTDIR}/rchost.p1.d
endif
else
${OBJECTDIR}/_ext/1493717523/radio.p1: ../robot-firmware/radio.c  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} ${OBJECTDIR}/_ext/1493717523 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/host-firmware.${IMAGE_TYPE}.cof: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) -odist/${CND_CONF}/${IMAGE_TYPE}/host-firmware.${IMAGE_TYPE}.cof -mdist/${CND_CONF}/${IMAGE_TYPE}/host-firmware.${IMAGE_TYPE}.map --summary=default,-psect,-class,+mem,-hex --chip=$(MP_PROCESSOR_OPTION) -P --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,+stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=default,+asm,-asmfile,+speed,-space,-debug,-9 -D__DEBUG --debugger=pickit3 -D_XTAL_FREQ=16000000 -DRADIO_EN_ANSEL=ANSELB -DRADIO_EN_TRIS=TRISB -DRADIO_EN_LAT=LATB -DRADIO_TXRX_ANSEL=ANSELB -DRADIO_TXRX_TRIS=TRISB -DRADIO_TXRX_LAT=LATB -DRADIO_SND_ANSEL=ANSELC -DRADIO_SND_TRIS=TRISC -DRADIO_SND_LAT=LATC -DRADIO_RCV_ANSEL=ANSELC -DRADIO_RCV_TRIS=TRISC -DRADIO_RCV_PORT=PORTC -DRADIO_EN_BIT=5 -DRADIO_TXRX_BIT=4 -DRADIO_SND_BIT=4 -DRADIO_RCV_BIT=5 -N31 --warn=9  --double=24 --float=24 --addrqual=ignore --mode=lite --output=default,-inhx032 -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s" ${OBJECTFILES}  
